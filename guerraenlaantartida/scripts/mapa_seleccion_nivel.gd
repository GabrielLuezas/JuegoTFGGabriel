...
func _ready():
	...
	if Global.nivelMaximoConseguido == 0:
		_on_boton_nivel_1_pressed()
		$Botones/BotonCampamento.hide()
	else:
...
func _on_boton_nivel_4_pressed():
	...
	$ContenidoLibro/CirculosSpritesFocasDelNivel.show()
	$Imagenes/ImagenFoca1.texture = load("res://img/Focas/FocaNormal/102.png")
	$Imagenes/ImagenFoca2.texture = load("res://img/Focas/FocaNormalChaleco/113.png")
	$Imagenes/ImagenFoca3.texture = load("res://img/Focas/FocaNormalChaleco/113.png")
	$Imagenes/ImagenFoca4.texture = load("res://img/Focas/FocaNormalChalecoCasco/123.png")
	$Imagenes/ImagenFoca5.texture = load("res://img/Focas/FocaTanque/T1.png")
	seleccionar_nivel(4)
...
func _on_boton_nivel_5_pressed():
	...
	$Imagenes/ImagenFoca1.texture = load("res://img/Focas/FocaNormal/102.png")
	$Imagenes/ImagenFoca2.texture = load("res://img/Focas/FocaNormalChaleco/113.png")
	$Imagenes/ImagenFoca3.texture = load("res://img/Focas/FocaNormalChalecoCasco/123.png")
	$Imagenes/ImagenFoca4.texture = load("res://img/Focas/FocaNormalChalecoCasco/123.png")
	$Imagenes/ImagenFoca5.texture = load("res://img/Focas/FocaTanque/T1.png")
	seleccionar_nivel(5)
...
func _on_boton_nivel_6_pressed():
	$Imagenes/Boss.hide()
	$ContenidoLibro/CirculosSpritesFocasDelNivel.show()
	$Imagenes/ImagenFoca1.texture = load("res://img/Focas/FocaNormalChaleco/113.png")
	$Imagenes/ImagenFoca2.texture = load("res://img/Focas/FocaNormalChalecoCasco/123.png")
	$Imagenes/ImagenFoca3.texture = load("res://img/Focas/FocaNormalChalecoCasco/123.png")
	$Imagenes/ImagenFoca4.texture = load("res://img/Focas/FocaTanque/T1.png")
	$Imagenes/ImagenFoca5.texture = load("res://img/Focas/FocaPayaso/P2.png")
	seleccionar_nivel(6)

func _on_boton_nivel_7_pressed():
	$Imagenes/Boss.hide()
	$ContenidoLibro/CirculosSpritesFocasDelNivel.show()
	$Imagenes/ImagenFoca1.texture = load("res://img/Focas/FocaPayaso/P2.png")
	$Imagenes/ImagenFoca2.texture = load("res://img/Focas/FocaPayaso/P2.png")
	$Imagenes/ImagenFoca3.texture = load("res://img/Focas/FocaPayaso/P2.png")
	$Imagenes/ImagenFoca4.texture = load("res://img/Focas/FocaPayaso/P2.png")
	$Imagenes/ImagenFoca5.texture = load("res://img/Focas/FocaPayaso/P2.png")
	seleccionar_nivel(7)
...
func _on_boton_nivel_8_pressed():
	$Imagenes/Boss.hide()
	$ContenidoLibro/CirculosSpritesFocasDelNivel.show()
	$Imagenes/ImagenFoca1.texture = load("res://img/Focas/FocaFuego/302.png")
	$Imagenes/ImagenFoca2.texture = load("res://img/Focas/FocaFuego/302.png")
	$Imagenes/ImagenFoca3.texture = load("res://img/Focas/FocaFuego/302.png")
	$Imagenes/ImagenFoca4.texture = load("res://img/Focas/FocaHielo/402.png")
	$Imagenes/ImagenFoca5.texture = load("res://img/Focas/FocaHielo/402.png")
	seleccionar_nivel(8)

func _on_boton_nivel_9_pressed():
	$Imagenes/Boss.hide()
	$ContenidoLibro/CirculosSpritesFocasDelNivel.show()
	$Imagenes/ImagenFoca1.texture = load("res://img/Focas/FocaNormalChalecoCasco/123.png")
	$Imagenes/ImagenFoca2.texture = load("res://img/Focas/FocaTanque/T1.png")
	$Imagenes/ImagenFoca3.texture = load("res://img/Focas/FocaPayaso/P2.png")
	$Imagenes/ImagenFoca4.texture = load("res://img/Focas/FocaFuego/302.png")
	$Imagenes/ImagenFoca5.texture = load("res://img/Focas/FocaHielo/402.png")
	seleccionar_nivel(9)
...
func _on_boton_jugar_pressed():
	...
	if texto == "JUGAR":
		...
		Global.rutaImagen1 = "res://img/FotoLibroTransicion.png"
